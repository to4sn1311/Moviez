...
if (strlen($_SESSION['username']) == 0) {
    ...
    if ($_GET['action'] == 'del' && $_GET['rid']) {
        $id = intval($_GET['rid']);
        $query = mysqli_query($conn, "delete from  admin  where admin_id ='$id' && type=0");
                                ...
                                <div class="demo-box m-t-20">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-colored-bordered table-bordered-primary">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($conn, "Select * from admin where type=0");
                                                $cnt = 1;
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($row['admin_acc']); ?></td>
                                                        <td><?php echo htmlentities($row['admin_email']); ?></td>
                                                        <td><?php echo htmlentities($row['admin_pas']); ?></td>
                                                        <td>
                                                            <a
                                                                href="edit-subadmin.php?said=<?php echo htmlentities($row['admin_id']); ?>"><i
                                                                    class="fa fa-pencil" style="color: #29b6f6;"></i>
                                                            </a>
                                                            &nbsp;
                                                            <a
                                                                href="manage-subadmins.php?rid=<?php echo htmlentities($row['admin_id']); ?>&&action=del">
