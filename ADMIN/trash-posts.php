...
if (strlen($_SESSION['username']) == 0) {
    ...
    if ($_GET['action'] == 'restore') {
        ...
        $query = mysqli_query($conn, "update `post` set `is_active`= 1 where `post-ID`= {$_GET['pid']}");
        if ($query) {
    ...
    if (isset($_GET['presid']) && $_GET['presid']) {
        $id = intval($_GET['presid']);
        $query = mysqli_query($conn, "delete from `post`  where `post-ID` ='$id'");
                                                ...
                                                WHERE post.is_active = 0");
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="trash-posts.php?pid=<?php echo htmlentities($row['id']); ?>&&action=restore" onclick="return confirm('Do you really want to restore ?')"> <i class="ion-arrow-return-right" title="Restore this Post"></i></a>
                                                                &nbsp;
