...
if (strlen($_SESSION['username']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $query = mysqli_query($conn, "INSERT INTO `post`(`post-title`, `post-des`, `category_id`, `post-detail`, `post-image`, `post-by`) VALUES ('$posttitle','$postdes','$catid','$postdetails','$imgnewfile','$postedby')");
            if ($query) {
                                ...
                                <div class="">
                                    <form name="addpost" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group m-b-20">
                                            ...
                                            <input type="text" class="form-control" id="post-des" name="post-des"
                                        ...
                                        <div class="form-group m-b-20">
                                            ...
                                            <select class="form-control" name="category" id="category" required>
                                                ...
                                                $ret = mysqli_query($conn, "select * from  category where is_active = 1");
