...
if (strlen($_SESSION['username']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $query = mysqli_query($conn, "update `post` set `post-image` ='$imgnewfile' where `post-ID`='$postid'");
            if ($query) {
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <form name="addpost" method="post" enctype="multipart/form-data">
                        <?php
                        $postid = intval($_GET['pid']);
                        $query = mysqli_query($conn, "select `post-image` AS `image`, `post-title` AS `title` from post where `post-ID`='$postid' and `is_active` =1 ");
