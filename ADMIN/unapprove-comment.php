                                    ...
                                    <div class="demo-box m-t-20">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query = mysqli_query($conn, "Select comment.`cmt-id` AS id,  comment.`user-name` AS name, comment.email, comment.`post-date` AS postingDate, comment.comment, post.`post-ID` as postid,post.`post-title` AS PostTitle from  comment join post on post.`post-ID`= comment.`post-ID` where comment.status=0");
                                                    $cnt = 1;
