...
if (strlen($_SESSION['username']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $password = $_POST['pwd'];
        $usertype = '0';
        $query = mysqli_query($conn, "insert into admin(admin_acc,admin_pas,admin_email,type) values('$username','$password','$email','$usertype')");
        if ($query) {
                                            ...
                                            <form class="form-horizontal" name="addsuadmin" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Enter Sub-Admin Username"
                                                        name="sadminusername" id="sadminusername" class="form-control"
