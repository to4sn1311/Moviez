...
if (strlen($_SESSION['username']) == 0) {
    ...
    if ($_GET['action'] == "del") {
        ...
        $query = mysqli_query($conn, "update `post` set `is_active` = 0 where `post-ID` = '$postid'");
        if ($query) {
            $msg = "Post deleted";
        } else {
                                        ...
                                        <table class="table table-colored table-centered table-inverse m-0">
                                            ...
                                            <tbody>
                                                ...
                                                $query = mysqli_query($conn, "SELECT `post`.`post-ID` AS `id`,
                                                    ...
                                                    `post`.`view` AS `view`,
                                                    `post`.`post-date` AS `post-date`,
                                                    `post`.`post-by` AS `post-by`,
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo htmlentities($row['post-by']) ?>
                                                    </td>
                                                    <td>
                                                        <?php echo htmlentities($row['view']) ?>
                                                    </td>
                                                    <td><a
                                                            href="edit-post.php?pid=<?php echo htmlentities($row['id']); ?>"><i
                                                                class="fa fa-pencil" style="color: #29b6f6;"></i></a>
                                                        &nbsp;<a
                                                            href="manage-posts.php?pid=<?php echo htmlentities($row['id']); ?>&&action=del"
